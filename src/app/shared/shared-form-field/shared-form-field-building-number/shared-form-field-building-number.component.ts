...
@Component({
  selector: 'app-shared-form-field-building-number',
  standalone: true,
  imports: [
    SharedFormFieldBaseComponent
  ],
  templateUrl: './shared-form-field-building-number.component.html',
  styleUrl: './shared-form-field-building-number.component.scss'
})
export class SharedFormFieldBuildingNumberComponent {
