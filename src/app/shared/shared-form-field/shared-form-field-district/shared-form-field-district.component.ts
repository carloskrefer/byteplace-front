...
@Component({
  selector: 'app-shared-form-field-district',
  standalone: true,
  imports: [
    SharedFormFieldBaseComponent
  ],
  templateUrl: './shared-form-field-district.component.html',
  styleUrl: './shared-form-field-district.component.scss'
})
export class SharedFormFieldDistrictComponent {
